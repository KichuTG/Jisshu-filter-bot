...
BOT_TOKEN = environ.get('BOT_TOKEN', '5689518722:AAEoeqHNZUPdhqi5U4BeUj42YWgau0V8Jg4')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5398056049 1905251964').split()]
USERNAME = environ.get('USERNAME', "https://t.me/kichuxd") # ADMIN USERNAME
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/DramaLabs') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://required-scorpion-balala-ba3fe5d5.koyeb.app")
